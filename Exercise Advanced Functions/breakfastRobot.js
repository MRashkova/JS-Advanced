function solve() {
    ...
    //declaration for variables for the microelements
    ...
    //декларация на вложени функции за обработка -> извършват операция върху микроелементите
    ...
    //декларация на мениджъра -> обработва входа и извиква една от функциите
    ...
    //връшане на референция към мениджъра
